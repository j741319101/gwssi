...
/* 128 */       sysIdentities.forEach(sysIdentity -> stringBuffer.append(sysIdentity.getName()).append(","));
/*     */ 
/*     */       
...
/* 146 */     sysIdentities.forEach(sysIdentity -> sb.append("user").append("-").append(sysIdentity.getName()).append("-").append(sysIdentity.getId()).append(","));
/*     */ 
/*     */ 
/*     */     
...
/* 196 */       identityList.add(new DefaultIdentity(link.getIdentity(), link.getIdentityName(), link.getType()));
/*     */     }
/*     */     
