...
/*     */ public class BpmInstanceManagerImpl
    ...
    @Resource
    /*  97 */ private TaskIdentityLinkManager taskIdentityLinkManager;
    ...
    public List<BpmTaskApproveVO> getApproveInstHistoryList(QueryFilter queryFilter) {
        /* 109 */
        queryFilter.addParamsFilter("approver", ContextUtil.getCurrentUserId());
        /* 110 */
        List<BpmTaskApproveVO> bpmTaskApproveDocVOS = this.bpmInstanceDao.getApproveInstHistoryList(queryFilter);
        /* 111 */
        bpmTaskApproveDocVOS.forEach(app -> {
            /*     */
            ...
            if (StringUtils.isNotEmpty(str)) {
                ...
                if (strs.length == 3) {
                    ...
                    /*     */
                    app.setApproveTime(com.dstz.sys.util.DateUtil.convertStr(strs[2]));
                    /*     */
                    app.setNodeName("");
                    /*     */
                }
    ...
    public BpmInstance genInstanceByDefinition(IBpmDefinition bpmDefinition) {
        ...
        if (user == null) {
            /* 158 */
            userDTO.setFullname("系统");
            /* 159 */
            userDTO.setUserId("system");
            /*     */
        }
        /* 161 */
        instance.setCreateBy(userDTO.getUserId());
        /* 162 */
        instance.setCreator(userDTO.getFullname());
        /* 163 */
    ...
    public void delete(String arrIds) {
        ...
        for (String id : ids) {
            ...
            if (!StringUtil.isEmpty(id)) {
                /*     */
                /* 197 */
                BpmInstance inst = (BpmInstance) get(id);
                /* 198 */
                if (inst != null) {
                    /*     */
                    /* 200 */
    ...
    private void delete(BpmInstance instance) {
        ...
        /* 214 */
        this.taskIdentityLinkManager.removeByInstId(instId);
        /* 215 */
        ...
        /* 219 */
        extendTaskActions.forEach(iExtendTaskAction -> iExtendTaskAction.deleteDataByInstId(instId));
        /*     */
        /* 221 */
        InstanceActionCmd instanceActionCmd = getInstCmd(instance);
        /* 222 */
        BpmContext.setActionModel((ActionCmd) instanceActionCmd);
        /* 223 */
        this.executionCommand.execute(EventType.DELETE_EVENT, instanceActionCmd);
        /*     */
        /* 225 */
        List<BpmBusLink> links = this.bpmBusLinkManager.getByInstanceId(instId);
        /* 226 */
        ...
        /*     */
        /* 236 */
        ThreadMapUtil.put("EcloudBPMDeleteInstance", Boolean.valueOf(true));
        /* 237 */
    ...
    public List<BpmInstance> getByParentId(String id) {
        /* 250 */
        return this.bpmInstanceDao.getByPId(id);
        /*     */
    }
    ...
    public void toForbidden(String instId, boolean forbidden) {
        /* 255 */
        List<BpmInstance> bpmInstanceList = listParentAndSubById(instId);
        /* 256 */
        if (CollectionUtils.isNotEmpty(bpmInstanceList)) {
            ...
            /* 259 */
            for (BpmInstance bpmInstance : bpmInstanceList) {
                /* 260 */
    ...
    public List<BpmInstance> listParentAndSubById(String instId) {
        /* 270 */
        BpmInstance bpmInstance = (BpmInstance) this.bpmInstanceDao.get(instId);
        /* 271 */
        if (bpmInstance == null) {
            /* 272 */
        ...
        /* 276 */
        getParentAndSiblingsInst(bpmInstanceList, bpmInstanceList);
        /* 277 */
        getChildrenInst(bpmInstanceList, bpmInstanceList);
        /* 278 */
    ...
    private void getParentAndSiblingsInst(List<BpmInstance> insts, List<BpmInstance> foundInsts) {
        /* 282 */
        List<String> toFindInstIds = new ArrayList<>();
        /* 283 */
        insts.stream().filter(inst ->
...
/* 286 */.forEach(foundInst -> toFindInstIds.add(foundInst.getParentInstId()));
        /*     */
        /* 288 */
        if (CollectionUtils.isEmpty(toFindInstIds)) {
            /*     */
            return;
            /*     */
        }
        ...
        /* 292 */
        List<WhereClause> whereClauses = defaultQueryFilter.getFieldLogic().getWhereClauses();
        /* 293 */
        DefaultFieldLogic orFieldLogic = new DefaultFieldLogic();
        /* 294 */
        orFieldLogic.setFieldRelation(FieldRelation.OR);
        /* 295 */
        orFieldLogic.getWhereClauses().add(new DefaultQueryField("id_", QueryOP.IN, toFindInstIds));
        /* 296 */
        orFieldLogic.getWhereClauses().add(new DefaultQueryField("parent_inst_id_", QueryOP.IN, toFindInstIds));
        /* 297 */
        whereClauses.add(orFieldLogic);
        /* 298 */
        List<BpmInstance> foundParentInst = this.bpmInstanceDao.query((QueryFilter) defaultQueryFilter);
        /* 299 */
        if (CollectionUtils.isEmpty(foundParentInst)) {
            /*     */
            return;
            /*     */
        }
        /* 302 */
        for (int i = 0; i < foundParentInst.size(); i++) {
            /* 303 */
            Iterator<BpmInstance> iterator = foundInsts.iterator();
            while (true) {
                if (iterator.hasNext()) {
                    BpmInstance fInst = iterator.next();
                    /* 304 */
                    if (StringUtils.equals(fInst.getId(), ((BpmInstance) foundParentInst.get(i)).getId())) {
                        /* 305 */
                        foundParentInst.remove(i);
                        /* 306 */
                        i--;
                        break;
                        /*     */
                ...
                /*     */
                /* 310 */
                foundInsts.add(foundParentInst.get(i));
                break;
            }
            /*     */
            /* 312 */
        }
        getParentAndSiblingsInst(foundParentInst, foundInsts);
        /*     */
    }
    ...
    private void getChildrenInst(List<BpmInstance> insts, List<BpmInstance> foundInsts) {
        ...
        List<String> toFindInstIds = new ArrayList<>();
        /* 317 */
        insts.stream().filter(inst -> !toFindInstIds.contains(inst.getParentInstId())).forEach(foundInst -> toFindInstIds.add(foundInst.getId()));
        /*     */
        /* 319 */
        if (CollectionUtils.isEmpty(toFindInstIds)) {
            /*     */
        ...
        DefaultQueryFilter defaultQueryFilter = new DefaultQueryFilter(true);
        /* 323 */
        defaultQueryFilter.addFilter("parent_inst_id_", toFindInstIds, QueryOP.IN);
        /* 324 */
        List<BpmInstance> foundParentInst = this.bpmInstanceDao.query((QueryFilter) defaultQueryFilter);
        /* 325 */
        if (CollectionUtils.isEmpty(foundParentInst)) {
        ...
        /* 328 */
        foundParentInst.stream().filter(inst -> !foundInsts.contains(inst)).forEach(inst -> foundInsts.add(inst));
        /* 329 */
        getChildrenInst(foundParentInst, foundInsts);
        /*     */
    }
    ...
    public List<Map> getInstNum() {
        /* 335 */
        return this.bpmInstanceDao.getInstNum();
        /*     */
    }
    ...
    public int updateStatus(String ids, String status) {
        ...
        /* 343 */
        return this.bpmInstanceDao.updateStatus(Arrays.asList(ids.split(",")), status, ContextUtil.getCurrentUserId());
        /*     */
    }
    ...
    public Map getInstIdByBusId(String busId) {
        /* 348 */
        return this.bpmInstanceDao.getInstIdByBusId(busId);
        /*     */
    }
    ...
    public BpmInstance createInstanceByExecution(ExecutionEntity executionEntity) {
        /* 354 */
        BpmDefinition bpmDefinition = this.bpmDefinitionMananger.getByKey(executionEntity.getProcessDefinitionKey());
        /*     */
        /* 356 */
        BpmInstance instance = genInstanceByDefinition((IBpmDefinition) bpmDefinition);
        /*     */
        /* 358 */
        instance.setActInstId(executionEntity.getProcessInstanceId());
        /* 359 */
        instance.setBizKey(executionEntity.getBusinessKey());
        /* 360 */
        instance.setHasCreate(Boolean.valueOf(true));
        /*     */
        /* 362 */
        create(instance);
        /* 363 */
    ...
    public List<BpmTypeTreeCountVO> getApproveHistoryListTypeCount(String userId, QueryFilter queryFilter) {
        ...
        /* 370 */
        return this.bpmInstanceDao.getApproveHistoryListTypeCount(queryFilter);
        /*     */
    }
    ...
    public List<BpmTypeTreeCountVO> applyTaskListTypeCount(String userId, QueryFilter queryFilter) {
        ...
        queryFilter.setPage(null);
        /* 377 */
        return this.bpmInstanceDao.getApplyListTypeCount(queryFilter);
        /*     */
    }
    ...
    public List<BpmInstanceVO> listInstTaskJson(QueryFilter queryFilter) {
        /* 382 */
        List<BpmInstanceVO> bpmInstanceVOS = this.bpmInstanceDao.listInstTaskJson(queryFilter);
        /* 383 */
        bpmInstanceVOS.forEach(bpmInstanceVO -> {
            /*     */
    ...
    public void listInstTaskJsonToExcel(QueryFilter queryFilter, OutputStream out) throws Exception {
        /* 412 */
        List<BpmInstanceVO> data = listInstTaskJson(queryFilter);
        /* 413 */
        ...
        fields.put("ZJR", "创建人");
        /* 418 */
        fields.put("WCSJ", "完成时间");
        /* 419 */
        fields.put("CXSJ", "持续时间");
        /* 420 */
        List<Map> map = new ArrayList<>();
        /* 421 */
        data.forEach(bpmInstanceVO -> {
            /*     */
        ...
        /* 444 */
        ExeclUtil.ListtoExecl(map, out, fields);
        /*     */
    }
    ...
    private InstanceActionCmd getInstCmd(BpmInstance bpmInstance) {
        ...
        /* 454 */
        instanceActionCmd.setDefId(bpmInstance.getDefId());
        /* 455 */
    ...
    public Map getInstanceStatusStatis(String instId) {
        /* 460 */
        return this.bpmInstanceDao.getInstanceStatusStatis(instId);
        /*     */
    }
    /*     */
}
