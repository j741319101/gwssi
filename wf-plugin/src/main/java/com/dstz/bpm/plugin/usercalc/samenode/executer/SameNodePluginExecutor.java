...
/* 34 */     List<SysIdentity> bpmIdentities = new ArrayList<>();
/* 35 */     IBpmTask task = pluginSession.getBpmTask();
/* 36 */     if (task == null) {
/* 37 */       return Collections.emptyList();
/*    */     }
/* 39 */     List<BpmTaskOpinion> taskOpinionList = this.taskOpinionManager.getByInstAndNodeVersion(pluginSession.getBpmTask().getInstId(), sameNodeDef.getNodeId());
...
/* 50 */       BpmIdentity bpmIdentity = new BpmIdentity(taskOpinion.getApprover(), taskOpinion.getApproverName(), "user");
/* 51 */       bpmIdentities.add(bpmIdentity);
/*    */     } 
/*    */ 
/*    */     
...
/* Location:              /Users/wangchenliang/Documents/workspace/ecloud/cn_分卷/cn/gwssi/ecloudbpm/wf-plugin/0.2-SNAPSHOT/wf-plugin-0.2-SNAPSHOT.jar!/cn/gwssi/ecloudbpm/bpm/plugin/usercalc/samenode/executer/SameNodePluginExecutor.class
