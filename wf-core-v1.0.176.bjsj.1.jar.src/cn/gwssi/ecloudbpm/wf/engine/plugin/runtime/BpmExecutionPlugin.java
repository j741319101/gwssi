...
public interface BpmExecutionPlugin<S extends com.dstz.bpm.engine.plugin.session.BpmExecutionPluginSession, M extends com.dstz.bpm.api.engine.plugin.def.BpmExecutionPluginDef> extends RunTimePlugin<S, M, Void> {}
