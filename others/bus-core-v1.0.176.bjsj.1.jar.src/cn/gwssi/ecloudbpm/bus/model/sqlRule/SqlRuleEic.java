...
/*    */ 
/*    */ 
/*    */ public class SqlRuleEic
/*    */   extends SqlRuleExpression
/*    */ {
/*    */   private static final long serialVersionUID = 700694295167942753L;
/*    */   
/*    */   public String getType() {
/* 20 */     return SqlRuleType.EIC.getKey();
/*    */   }
/*    */ 
/*    */   
/*    */   String getDefaultSql(ISqlRuleParam sqlRuleParam) {
/* 25 */     String id = IdUtil.getSuid();
/* 26 */     String defaultSql = "upper(" + this.filter + ") " + SqlRuleType.getByKey(getType()).getKeyword() + " upper(#{" + id + "})";
/* 27 */     return initSql(sqlRuleParam, defaultSql, id);
/*    */   }
/*    */ }


/* Location:              /Users/wangchenliang/Documents/workspace/ecloud/cn_分卷/cn/gwssi/ecloud/bus-core/v1.0.176.bjsj.1/bus-core-v1.0.176.bjsj.1.jar!/cn/gwssi/ecloudbpm/bus/model/sqlRule/SqlRuleEic.class
